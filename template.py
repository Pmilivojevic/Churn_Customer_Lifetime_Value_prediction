...
list_of_files = [
    ...
    f"{project_name}/components/c_01_data_ingestion.py",
    f"{project_name}/components/c_02_data_validation.py",
    f"{project_name}/components/c_03_data_transformation.py",
    f"{project_name}/components/c_04_model_trainer.py",
    f"{project_name}/components/c_05_model_evaluation.py",
    ...
    f"{project_name}/pipelines/stage_06_prediction_pipeline.py",
